...
<div class="form">
<form action="index.php?action=addPersonnage" method="POST" class="categorie-form">
    <label for="nom">Nom</label>
    <input name="nom" id="nom" type="text" placeholder="Nom du personnage" required>
...
<?php
$titre = "Ajouter un personnage";
$titre_secondaire = "Ajouter un personnage";
