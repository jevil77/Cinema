...
<div class="form">
<form action="index.php?action=addCategorie" method="POST" class="categorie-form">
    <label for="addType">Ajouter  </label>
    <input name="newGenre" id="newGenre" type="text" placeholder="Nom de la catégorie" required>
...
$titre_secondaire = "Ajouter catégorie";
